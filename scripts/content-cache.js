import { bigBangLegacyContent } from "../data/legacy-big-bang.js?v=20260529-equation-meaning-audit-v1";
import { siteContent } from "../data/site-content.js?v=20260529-equation-meaning-audit-v1";

const documentCache = new Map();
const requestCache = new Map();
const CONTENT_CACHE_VERSION = "20260529-equation-meaning-audit-v1";
