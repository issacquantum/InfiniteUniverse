import { siteAssets } from "../data/site-assets.js?v=20260614-photon-tabs-equations-icons-v1";
import { siteContent } from "../data/site-content.js?v=20260614-photon-tabs-equations-icons-v1";
import { createReadingSettingsController } from "./reading-settings.js?v=20260614-photon-tabs-equations-icons-v1";
import { initBackground } from "./background.js?v=20260614-photon-tabs-equations-icons-v1";
import { refreshIcons } from "./icons.js?v=20260614-photon-tabs-equations-icons-v1";
import { pick } from "./i18n.js?v=20260614-photon-tabs-equations-icons-v1";
import { decoratePhotonOutlines } from "./creative-effects.js?v=20260614-photon-tabs-equations-icons-v1";
import { syncLegacyContent } from "./legacy-content.js?v=20260614-photon-tabs-equations-icons-v1";
import { createMusicController, syncMusicUi } from "./music.js?v=20260614-photon-tabs-equations-icons-v1";
import { renderSite } from "./render.js?v=20260614-photon-tabs-equations-icons-v1";
import { createState } from "./state.js?v=20260614-photon-tabs-equations-icons-v1";
import { syncStructuredContent } from "./structured-content.js?v=20260614-photon-tabs-equations-icons-v1";
import { markWebGLAvailability } from "./webgl-support.js?v=20260614-photon-tabs-equations-icons-v1";
...
function syncUi(state = store.getState()) {
  ...
  document.body.dataset.music = musicUiState.isPlaying ? "playing" : "idle";
...
function selectLegacyItem(branchId, itemId) {
  store.setState((state) => {
    ...
    return {
      ...
      showPersonalSectionList: false,
      activeDomain: sectionOwnsBranch ? null : state.activeDomain,
      activeTopic: sectionOwnsBranch ? null : state.activeTopic,
      activeBranch: branchId,
      activeDetail: itemId,
