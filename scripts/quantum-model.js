...
import { OrbitalCamera } from "./orbital-camera.js?v=20260524-phone-serif-v1";
...
async function mountModel(host) {
  ...
  const [vertexSource, fragmentSource] = await Promise.all([
    ...
    fetchShader(new URL("../shaders/orbital.frag.glsl?v=20260524-phone-serif-v1", import.meta.url))
  ]);
