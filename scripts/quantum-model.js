...
import { OrbitalCamera } from "./orbital-camera.js?v=20260514-orbital-purple-nucleus";
...
async function mountModel(host) {
  ...
  const [vertexSource, fragmentSource] = await Promise.all([
    ...
    fetchShader(new URL("../shaders/orbital.frag.glsl?v=20260514-orbital-purple-nucleus", import.meta.url))
  ]);
